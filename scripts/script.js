document.addEventListener('DOMContentLoaded', () => {
  ...
  const characterData = {
    ...
    character2: {
      description: ' Утратив Искру, мы лишились возможности вернуть нашу планету к жизни. Но судьба в награду подарила нам новый мир, который мы назовём своим домом. Теперь мы живём среди людей, скрывая свое истинное лицо, и тайно за ними наблюдаем… Ждём, защищаем. Я увидел, на какую отвагу они способны, и хотя нас разделяют миры, с ними, как и с нами всё не так.',
      head: 'Вода - жидкий',
      image: 'public/img/waterman.png',
      useBut: 'public/img/But/ButWater.svg',
      But: 'public/img/But/water.svg',
      vec: 'btn4',
    ...
    character3: {
      description: ' Утратив Искру, мы лишились возможности вернуть нашу планету к жизни. Но судьба в награду подарила нам новый мир, который мы назовём своим домом. Теперь мы живём среди людей, скрывая свое истинное лицо, и тайно за ними наблюдаем… Ждём, защищаем. Я увидел, на какую отвагу они способны, и хотя нас разделяют миры, с ними, как и с нами всё не так.', 
      head: 'Зе(м)ля - хто я?',
      image: 'public/img/earthman.png',
      useBut: 'public/img/But/ButEarth.svg',
      But: 'public/img/But/earth.svg',
      vec: 'btn2',
    },
    character4: {
      description: 'Утратив Искру, мы лишились возможности вернуть нашу планету к жизни. Но судьба в награду подарила нам новый мир, который мы назовём своим домом. Теперь мы живём среди людей, скрывая свое истинное лицо, и тайно за ними наблюдаем… Ждём, защищаем. Я увидел, на какую отвагу они способны, и хотя нас разделяют миры, с ними, как и с нами всё не так.',
      head: 'Воздух - воздухан',
      image: 'public/img/wingman.png',
      useBut: 'public/img/But/ButWind.svg',
      But: 'public/img/But/wind.svg',
      vec: 'btn3',
    },
  };
