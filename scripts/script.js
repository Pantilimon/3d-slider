document.addEventListener('DOMContentLoaded', () => {
  ...
  const characterData = {
    character1: {
      description: 'Мастера клинка, создающие захватывающие и увлекательные игровые миры, наполненные яркими красками, динамикой и адреналином, способные ранить вас в самое сердечко. Они обладают уникальным видением и искусством вдохнуть жизнь в самые смелые идеи, превращая их в незабываемые игровые приключения.',
